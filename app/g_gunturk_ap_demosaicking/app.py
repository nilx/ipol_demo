"""
Gunturk-Altunbasak-Mersereau Alternating Projections ipol demo web app
"""
...
class app(base_app):
    ...
    def __init__(self):
        ...
        self.xlink_algo = 'http://www.ipol.im/pub/art/2011/g_gapd/'
    ...
    def run(self):
        ...
        if self.cfg['meta']['original']:
            ...
            ar.add_file("mosaiced.png", 
                info="mosaiced image")
            ar.add_file("gunturk.png", 
                info="Gunturk demosaiced image")
            ar.add_file("diffgunturk.png", 
                info="difference image for Gunturk")
            ar.add_file("ha.png", 
                info="Hamilton-Adams demosaiced image")
            ar.add_file("diffha.png", 
                info="difference image for Hamilton-Adams")
    ...
    def run_algo(self, stdout=None):
        ...
        # Demosaic image
        self.wait_proc(self.run_proc(['dmha', '-p', pattern, 
                'mosaiced.png', 'ha.png'],
                stdout=stdout, stderr=stdout), timeout*0.2)
                
        self.wait_proc(self.run_proc(['dmgunturk', '-p', pattern,
                'ha.png', 'gunturk.png'],
                stdout=stdout, stderr=stdout), timeout*0.4)

        # Compute image differences
        self.wait_proc([
            self.run_proc(['imdiff', 'input_0_sel.png', 
                'gunturk.png', 'diffgunturk.png'],
        ...
        for filename in ['input_0_sel', 'mosaiced', 'gunturk', 'ha',
            'diffgunturk', 'diffha']:
