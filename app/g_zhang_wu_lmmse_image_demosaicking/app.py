...
class app(base_app):
    ...
    def build(self):
        ...
        tgz_url = 'http://www.ipol.im/pub/art/2011/g_zwld/src.tar.gz'
        tgz_file = self.dl_dir + 'src.tar.gz'
        progs = ['dmzhangwu', 'dmbilinear', 'mosaic', 'imdiff']
        sub_dir = 'dmzhangwu-src'
    ...
    def run_algo(self, stdout=None):
        ...
        # Demosaic image
        self.wait_proc([ 
            self.run_proc(['dmzhangwu', '-p', pattern, 
                'mosaiced.png', 'dmzhangwu.png'],
        ...
        self.wait_proc([
            self.run_proc(['imdiff', 'input_0_sel.png', 
                'dmzhangwu.png', 'diffdmzhangwu.png'],
                stdout=stdout, stderr=stdout),
            self.run_proc(['imdiff', 'input_0_sel.png', 
        ...
        for filename in ['input_0_sel', 'mosaiced', 'dmzhangwu', 'bilinear',
