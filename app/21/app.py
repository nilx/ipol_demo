...
class app(base_app):
    ...
    xlink_article = 'http://www.ipol.im/pub/art/2013/21/'

    is_test = False
    is_listed = True
    is_built = True

    xlink_src = "http://www.ipol.im/pub/art/2013/21/sms_optic_flow_2.0.tar.gz"

    xlink_src_demo = "http://www.ipol.im/pub/art/2013/21/imscript_dec2011.tar.gz"
